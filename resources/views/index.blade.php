                ...
                <div class="row align-items-center">
                    <div class="col-lg-12 col-xl-6 order-2 order-xl-1">
                        <div class="inner">
                            ...
                            <h1 class="title">Have your dream course in minutes <br > for
                                <span class="cd-headline slide">
                            <span class="cd-words-wrapper">
                            <b class="is-hidden theme-gradient">Online Teacher.</b>
                            <b class="is-visible theme-gradient">Like Udemy.</b>
                            <b class="is-hidden theme-gradient">Virtual Teacher.</b>
                            <b class="is-hidden theme-gradient">University.</b>
                            <b class="is-hidden theme-gradient">Course.</b>
                            </span>
                            </span>
                            </h1>
                            <p class="description">The most <strong>powerful service</strong> support for
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <div class="video-popup-wrapper">
                        ...
                        <a class="rbt-btn rounded-player popup-video position-to-top rbtplayer" href="https://www.youtube.com/watch?v=KZj-8uYy6PE">
                            ...
                            <div class="row g-5">
                                <div class="col-lg-4 col-md-12 col-sm-12 col-12 mt_md--30 mt_sm--30 order-2 order-lg-1">
                                    ...
                                    <span class="subtitle bg-primary-opacity">All in One for Education
                                        ...
                                        <h4 class="title">Everything is ready, Just Learn.</h4>
                                    </div>
                                        ...
                                        <ul class="nav nav-tabs splash-nav-tabs tab-button-list" id="splashLayoutTab" role="tablist">
                                            <li class="nav-item active-nav" role="presentation">
                                                <a href="#" class="nav-link tab-button active" id="layouttab1-tab" data-bs-toggle="tab" data-bs-target="#layouttab1" role="tab" aria-controls="layouttab1" aria-selected="false">
                                                    <div class="tab">
                                                        <h4 class="title"><img src="assets/images/splash/icons/online-course.png" alt="advance-tab-image"> Variable Courses.</h4>
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a href="#" class="nav-link tab-button" id="layouttab2-tab" data-bs-toggle="tab" data-bs-target="#layouttab2" role="tab" aria-controls="layouttab2" aria-selected="true">
                                                    <div class="tab">
                                                        <h4 class="title"><img src="assets/images/splash/icons/header.png" alt="advance-tab-image"> Many Services.</h4>
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a href="#" class="nav-link tab-button" id="layouttab3-tab" data-bs-toggle="tab" data-bs-target="#layouttab3" role="tab" aria-controls="layouttab3" aria-selected="false">
                                                    <div class="tab">
                                                        <h4 class="title"><img src="assets/images/splash/icons/curve.png" alt="advance-tab-image"> Flexible time.</h4>
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a href="#" class="nav-link tab-button" id="layouttab4-tab" data-bs-toggle="tab" data-bs-target="#layouttab4" role="tab" aria-controls="layouttab4" aria-selected="false">
                                                    <div class="tab">
                                                        <h4 class="title"><img src="assets/images/splash/icons/web-programming.png" alt="advance-tab-image"> Interact Easily</h4>
                                                    </div>
                                                </a>
                                            </li>
                                        </ul>
...
--}}
                    ...
                    <div class="rbt-team-tab-content tab-content" id="myTabContent">
                            ...
                            <div class="inner">
                                ...
                                <div class="rbt-team-details">
                                    <div class="author-info">
                                        <h4 class="title">Tran Cam Ly</h4>
                                        <span class="designation theme-gradient">Leader</span>
                                        <span class="team-form">
                                    <i class="feather-map-pin"></i>
                                    <span class="location">Business administration</span>
                                    </span>
                                    </div>
                                    <p>Project management (PM)</p>
                                    ...
                                    <ul class="rbt-information-list mt--25">
                                        <li>
                                            <a href="mailto:lamdy.work@gmail.com"><i class="feather-mail"></i>lamdy.work@gmail.com</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="team-tab2" role="tabpanel" aria-labelledby="team-tab2-tab">
                            <div class="inner">
                                ...
                                <div class="rbt-team-details">
                                    <div class="author-info">
                                        <h4 class="title">Vo Thi Thanh Tam</h4>
                                        <span class="designation theme-gradient">Marketing</span>
                                        <span class="team-form">
                                    <i class="feather-map-pin"></i>
                                    <span class="location">Business administration</span>
                                    </span>
                                    </div>
                                    <p>Marketing, in charge of communication and advertising activities.
                                    </p>
                                    <ul class="social-icon social-default mt--20 justify-content-start">
                                        <li><a href="https://www.facebook.com/">
                                                <i class="feather-facebook"></i>
                                    ...
                                    <ul class="rbt-information-list mt--25">
                                        <li>
                                            <a href="mailto:vothithanhtam.2003x@gmail.com"><i class="feather-mail"></i>vothithanhtam.2003x@gmail.com</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="team-tab3" role="tabpanel" aria-labelledby="team-tab3-tab">
                            <div class="inner">
                                ...
                                <div class="rbt-team-details">
                                    <div class="author-info">
                                        <h4 class="title">Phan Tien Dung</h4>
                                        <span class="designation theme-gradient">Finance</span>
                                        <span class="team-form">
                                    <i class="feather-map-pin"></i>
                                    <span class="location">Business administration</span>
                                    </span>
                                    </div>
                                    <p>Business Analysis, in charge of finance and business analysis.
                                    </p>
                                    <ul class="social-icon social-default mt--20 justify-content-start">
                                        <li><a href="https://www.facebook.com/">
                                                <i class="feather-facebook"></i>
                                    ...
                                    <ul class="rbt-information-list mt--25">
                                        <li>
                                            <a href="mailto:phantiendung2906@gmail.com"><i class="feather-mail"></i>phantiendung2906@gmail.com</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="team-tab4" role="tabpanel" aria-labelledby="team-tab4-tab">
                            <div class="inner">
                                ...
                                <div class="rbt-team-details">
                                    <div class="author-info">
                                        <h4 class="title">Truong Thi Ngoc Anh</h4>
                                        <span class="designation theme-gradient">CRM</span>
                                        <span class="team-form">
                                    <i class="feather-map-pin"></i>
                                    <span class="location">Social Sciences & Humanities</span>
                                    </span>
                                    </div>
                                    <p>Customer Relationship Manager, in charge of customer relations
                                    </p>
                                    <ul class="social-icon social-default mt--20 justify-content-start">
                                        <li><a href="https://www.facebook.com/">
                                                <i class="feather-facebook"></i>
                                    ...
                                    <ul class="rbt-information-list mt--25">
                                        <li>
                                            <a href="mailto:truongngocanh.en@gmail.com"><i class="feather-mail"></i>truongngocanh.en@gmail.com</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="inner">
                                ...
                                <div class="rbt-team-details">
                                    <div class="author-info">
                                        ...
                                        <span class="designation theme-gradient">IT</span>
                                        <span class="team-form">
                                    <i class="feather-map-pin"></i>
                                    ...
                                    <p>
                                        Main Dev, in charge of the IT team in both hardware and software
                                    </p>
                                    <ul class="social-icon social-default mt--20 justify-content-start">
                                        <li><a href="https://www.facebook.com/">
                                                <i class="feather-facebook"></i>
                                    ...
                                    <ul class="rbt-information-list mt--25">
                                        <li>
                                            <a href="mailto:huuloc@maoleng.dev"><i class="feather-mail"></i>huuloc@maoleng.dev</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <span class="btn-text">Register SVHub Now</span>
    ...
    <div class="rbt-splash-testimonial-area bg-color-white overflow-hidden position-relative pt--100">
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-center">
                            ...
                            <span class="cd-words-wrapper">
                            <b class="is-visible theme-gradient">SVHub.</b>
        ...
        <div class="splash-testimonial-all-wrapper pb--60">
                        ...
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p class="subtitle-3">Learning online with AI teachers has revolutionized my education. It's convenient, interactive, and tailored to my needs</p>
                    ...
                    <div class="single-column-20 bg-theme-gradient-odd">
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p class="subtitle-3">I never thought I'd enjoy studying until I discovered online courses with AI teachers. It's engaging and flexible!</p>
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="assets/images/splash/icons/envato.png" alt="Clint Images">
                                        </div>
                    ...
                    <div class="single-column-20 bg-theme-gradient-odd">
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p class="subtitle-3">Thanks to AI teachers, I can learn anytime, anywhere. It's like having a personal tutor available 24/7.</p>
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="assets/images/splash/icons/envato.png" alt="Clint Images">
                                        </div>
                    ...
                    <div class="single-column-20 bg-theme-gradient-odd">
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p class="subtitle-3">Online courses with AI teachers provide invaluable real-time feedback that helps me grasp concepts faster.</p>
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="assets/images/splash/icons/envato.png" alt="Clint Images">
                                        </div>
                    ...
                    <div class="single-column-20 bg-theme-gradient-odd">
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p class="subtitle-3">The variety of subjects offered by online courses with AI teachers has expanded my knowledge beyond imagination.</p>
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="assets/images/splash/icons/envato.png" alt="Clint Images">
                                        </div>
                    ...
                    <div class="single-column-20 bg-theme-gradient-odd">
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p class="subtitle-3">Learning online has saved me money and time. It's the most cost-effective and efficient way to gain new skills.</p>
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="assets/images/splash/icons/envato.png" alt="Clint Images">
                                        </div>
                    ...
                    <div class="single-column-20 bg-theme-gradient-odd">
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p class="subtitle-3">Interacting with AI teachers has made my learning experience personalized and tailored to my specific needs.</p>
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="assets/images/splash/icons/envato.png" alt="Clint Images">
                                        </div>
                    ...
                    <div class="single-column-20 bg-theme-gradient-odd">
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p class="subtitle-3">The interactive simulations in online courses with AI teachers make learning fun and practical.</p>
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="assets/images/splash/icons/envato.png" alt="Clint Images">
                                        </div>
                    ...
                    <div class="single-column-20 bg-theme-gradient-odd">
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p class="subtitle-3">With online courses and AI teachers, I can continually learn and stay updated in a fast-changing world.</p>
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="assets/images/splash/icons/envato.png" alt="Clint Images">
                                        </div>
                            ...
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p class="subtitle-3">I have never seen support as fast and efficient as this one.
                                        I can't say anything about the theme yet since I just started building the site, but with this kind of support, <strong>I am confident it will be awesome</strong>.
                                    </p>
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="assets/images/splash/icons/envato.png" alt="Clint Images">
                            ...
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p class="subtitle-3">Beautiful theme! (Of course, that’s why I got it). But most
                                        ...
                                        finding it hard to install and customise the demo but he guided
                                    </p>
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="assets/images/splash/icons/envato.png" alt="Clint Images">
                            ...
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p class="subtitle-3">The theme itself suits my needs, but the support is the superstar
                                        that earns this theme and the team behind it a 5 stars rating. Kudos!
                                    </p>
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="assets/images/splash/icons/envato.png" alt="Clint Images">
            ...
            <div class="read-more-review">
                <div class="section-title text-center mb--30">
                    <h5 class="title color-white">Our Fantastic <br> Customers Reviews</h5>
                </div>
